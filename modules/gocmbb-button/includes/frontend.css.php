<?php  $gocmbbRgbaColors = new GOCMBB_Rgba_Colors(); ?>
...
.fl-node-<?php echo $id; ?> .gocmbb-btn-main a.gocmbb-btn {
...
.fl-node-<?php echo $id; ?> .gocmbb-btn-main {
...
<?php if ($settings->button_style == 'gradient') {
	$bg_grad_start = '#'.FLBuilderColor::adjust_brightness( $gocmbbRgbaColors->gocmbb_parse_color_to_hex( $settings->button_background_color ), 80, 'lighten' );
	$bg_hover_grad_start = '#'. FLBuilderColor::adjust_brightness( $gocmbbRgbaColors->gocmbb_parse_color_to_hex( $settings->button_background_hover_color ), 80, 'lighten' );
?>
.fl-node-<?php echo $id; ?> .gocmbb-btn-main a.gocmbb-btn {
...
.fl-node-<?php echo $id; ?> .gocmbb-btn-main a.gocmbb-btn:hover {
...
.fl-node-<?php echo $id; ?> .gocmbb-btn-main a.gocmbb-btn {
<?php $shadow_color = FLBuilderColor::adjust_brightness( $gocmbbRgbaColors->gocmbb_parse_color_to_hex( $settings->button_background_color ), 30, 'darken' ); ?> <?php if(isset($settings->button_border_radius['top'] ) ) { ?> border-top-left-radius: <?php echo $settings->button_border_radius['top'].'px';?>;
...
<?php $shadow_color_hover = FLBuilderColor::adjust_brightness( $gocmbbRgbaColors->gocmbb_parse_color_to_hex( $settings->button_background_hover_color ), 30, 'darken' ); ?> box-shadow: 0 4px<?php echo '#'.$shadow_color_hover; ?>;
}

.fl-node-<?php echo $id; ?> .gocmbb-btn-main a.gocmbb-btn:active {
...
.fl-node-<?php echo $id; ?> .gocmbb-btn-main a.gocmbb-btn i {
...
.fl-node-<?php echo $id; ?> .gocmbb-btn-main a.gocmbb-btn:hover i {
