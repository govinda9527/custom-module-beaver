(function ($) {
    ...
    $('.fl-node-<?php echo $id; ?> .gocmbb-arrow-wrapper .gocmbb-slider-next').empty();
    $('.fl-node-<?php echo $id; ?> .gocmbb-arrow-wrapper .gocmbb-slider-prev').empty();
    var window_width = $(window).width();

    var section_width = $('.fl-node-<?php echo $id; ?> .gocmbb-testimonial.layout-<?php echo $settings->testimonial_layout;?>').width();
    var section_height = $('.fl-node-<?php echo $id; ?> .gocmbb-testimonial.layout-<?php echo $settings->testimonial_layout;?>').height();
    var sliderOptions = {
        auto: true,
        ...
        nextSelector: '.fl-node-<?php echo $id; ?> .gocmbb-arrow-wrapper .gocmbb-slider-next',
        prevSelector: '.fl-node-<?php echo $id; ?> .gocmbb-arrow-wrapper .gocmbb-slider-prev',
        nextText: '<i class="fa fa-angle-right"></i>',
        prevText: '<i class="fa fa-angle-left"></i>',
        controls: <?php echo $settings->arrows; ?>,
        onSliderLoad: function () {
            $('.fl-node-<?php echo $id; ?> .gocmbb-testimonials').addClass('gocmbb-testimonials-loaded');
        }
    };
    ...
    $('.fl-node-<?php echo $id; ?> .gocmbb-testimonial-wrapper').bxSlider($.extend({}, sliderOptions, carouselOptions));
	<?php endif; ?>
})(jQuery);
