.fl-node-<?php echo $id; ?> .gocmbb-arrow-wrapper.gocmbb-bottom-arrow {
<?php
...
.fl-node-<?php echo $id; ?> .gocmbb-testimonial.layout-<?php echo $settings->testimonial_layout; ?> a.bx-pager-link {
<?php if( $settings->dot_color ) { ?> background: <?php echo '#'.$settings->dot_color; ?><?php } ?>;
    opacity: 0.5;
}

.fl-node-<?php echo $id; ?> .gocmbb-testimonial.layout-<?php echo $settings->testimonial_layout; ?> a.bx-pager-link.active {
<?php if( $settings->active_dot_color ) { ?> background: <?php echo '#'.$settings->active_dot_color; ?>;
<?php } ?> opacity: 1;
}

.fl-node-<?php echo $id; ?> .gocmbb-testimonial.layout-<?php echo $settings->testimonial_layout; ?> .gocmbb-arrow-wrapper i.fa {
    color: <?php echo '#'.$settings->arrow_color; ?>;
    font-size: <?php echo $settings->arrows_size.'px'; ?>;
}

<?php  if($settings->show_quote === 'yes'){ ?>
.fl-node-<?php echo $id; ?> .gocmbb-testimonial.layout-9 .gocmbb-testimonial-quote-icon,
.fl-node-<?php echo $id; ?> .gocmbb-testimonial.layout-9 .gocmbb-testimonial-quote-icon-two {
<?php if( $settings->quote_sign_color ) { ?> color: <?php echo '#'.$settings->quote_sign_color; ?>;
<?php } ?>
}

<?php } ?>
.fl-node-<?php echo $id; ?> .gocmbb-testimonial-main .testimonial-body-right {
...
.fl-node-<?php echo $id; ?> .gocmbb-testimonial-heading h1 {
...
.fl-node-<?php echo $id; ?> .gocmbb-testimonial-heading h1::before {
<?php if( $settings->heading_color ) { ?> background-color: <?php echo '#'.$settings->heading_color; ?>;
<?php } ?>
}

.fl-node-<?php echo $id; ?> .gocmbb-testimonial-image img {
...
.fl-node-<?php echo $id; ?> .gocmbb-testimonial-content {
...
.fl-node-<?php echo $id; ?> .gocmbb-testimonial-title {
...
.fl-node-<?php echo $id; ?> .gocmbb-testimonial-sub-title {
...
.fl-node-<?php echo $id; ?> .gocmbb-testimonial-body.layout_2 {
<?php if( $settings->box_border_color ) { ?> border-color: <?php echo '#'.$settings->box_border_color; ?>;
<?php } ?> <?php if( $settings->box_border_radius ) { ?> border-radius: <?php echo $settings->box_border_radius.'px'; ?>;
<?php } ?> <?php if( $settings->box_border_style ) { ?> border-style: <?php echo $settings->box_border_style; ?>;
<?php } ?> <?php if( $settings->box_border_width ) { ?> border-width: <?php echo $settings->box_border_width.'px'; ?>;
...
.fl-node-<?php echo $id; ?> .gocmbb-testimonial-body.layout_3 .gocmbb-testimonial-body-right {
<?php if( $settings->box_border_color ) { ?> border-color: <?php echo '#'.$settings->box_border_color; ?>;
<?php } ?> <?php if( $settings->box_border_radius ) { ?> border-radius: <?php echo $settings->box_border_radius.'px'; ?>;
<?php } ?> <?php if( $settings->box_border_style ) { ?> border-style: <?php echo $settings->box_border_style; ?>;
<?php } ?> <?php if( $settings->box_border_width ) { ?> border-width: <?php echo $settings->box_border_width.'px'; ?>;
...
.gocmbb-testimonial.layout-3 .gocmbb-testimonial-body-right::before {
    border-style: solid;
...
.fl-node-<?php echo $id; ?> .gocmbb-testimonial.layout-3 .gocmbb-testimonial-body-right::before {
...
.fl-node-<?php echo $id; ?> .gocmbb-testimonial-main.layout-3 .gocmbb-content-arrow-left {
...
.fl-node-<?php echo $id; ?> .gocmbb-testimonial-body.layout_4 {
<?php if( $settings->box_border_color ) { ?> border-color: <?php echo '#'.$settings->box_border_color; ?>;
<?php } ?> <?php if( $settings->box_border_radius ) { ?> border-radius: <?php echo $settings->box_border_radius.'px'; ?>;
<?php } ?> <?php if( $settings->box_border_style ) { ?> border-style: <?php echo $settings->box_border_style; ?>;
<?php } ?> <?php if( $settings->box_border_width ) { ?> border-width: <?php echo $settings->box_border_width.'px'; ?>;
...
.fl-node-<?php echo $id; ?> .gocmbb-testimonial.layout-4 .bx-viewport {
    height: auto !important;
}

<?php } ?>
<?php if( $settings->testimonial_layout == 5 ) { ?>
.fl-node-<?php echo $id; ?> .gocmbb-testimonial-body.layout_5 {
...
.fl-node-<?php echo $id; ?> .gocmbb-testimonial.layout-6 .gocmbb-testimonial-title {
<?php if( $settings->box_border_color ) { ?> border-color: <?php echo '#'.$settings->box_border_color; ?>;
<?php } ?> <?php if( isset($settings->content_box_padding['top'] ) ) { ?> padding-top: <?php echo $settings->content_box_padding['top'].'px'; ?>;
<?php } ?> <?php if( isset($settings->content_box_padding['bottom'] ) ) { ?> padding-bottom: <?php echo $settings->content_box_padding['bottom'].'px'; ?>;
<?php } ?> <?php if( isset($settings->content_box_padding['left'] ) ) { ?> padding-left: <?php echo $settings->content_box_padding['left'].'px'; ?>;
...
.fl-node-<?php echo $id; ?> .gocmbb-testimonial.layout-6 .gocmbb-testimonial-body-left {
...
.fl-node-<?php echo $id; ?> .gocmbb-testimonial.layout-7 .gocmbb-testimonial-body-right {
<?php if( $settings->img_bg_color ) { ?> background-color: <?php echo '#'.$settings->img_bg_color; ?>;
<?php } ?>
}

.fl-node-<?php echo $id; ?> .gocmbb-testimonial-body.layout_7 {
...
.fl-node-<?php echo $id; ?> .gocmbb-testimonial.layout-7 .gocmbb-testimonial-body img {
<?php if( $settings->border_color ) { ?> border-color: <?php echo '#'.$settings->border_color; ?>;
<?php } ?> <?php if( $settings->border_width ) { ?> border-width: <?php echo $settings->border_width.'px'; ?>;
<?php } ?> <?php if( $settings->border_radius ) { ?> border-radius: <?php echo $settings->border_radius.'px'; ?>;
<?php } ?> <?php if( $settings->image_border_style ) { ?> border-style: <?php echo $settings->image_border_style; ?>;
...
<?php  if($settings->show_indicator === 'yes'){ ?>
.gocmbb-testimonial.layout-7 .gocmbb-testimonial-body-left::after {
...
.fl-node-<?php echo $id; ?> .gocmbb-testimonial.layout-7 .gocmbb-testimonial-body-left::after {
...
<?php } ?>
<?php  if($settings->show_quote === 'yes'){ ?>
.gocmbb-testimonial.layout-7 .gocmbb-testimonial-body-left p:before {
    color: #fff;
    font-size: 80px;
    left: 80px;
    opacity: 0.2;
...
.fl-node-<?php echo $id; ?> .gocmbb-testimonial.layout-7 .gocmbb-testimonial-body-left p:before {
<?php if( $settings->quote_sign_color ) { ?> color: <?php echo '#'.$settings->quote_sign_color; ?>;
<?php } ?>
}
...
.fl-node-<?php echo $id; ?> .gocmbb-testimonial.layout-8 .gocmbb-testimonial-body-right {
<?php if( $settings->img_bg_color ) { ?> background-color: <?php echo '#'.$settings->img_bg_color; ?>;
<?php } ?>
}

.fl-node-<?php echo $id; ?> .gocmbb-testimonial-body.layout_8 {
<?php if( $settings->layout_4_content_bg ) { ?> background: <?php echo '#'.$settings->layout_4_content_bg; ?>;
<?php } ?><?php if( isset($settings->content_box_padding['top'] ) ) { ?> padding-top: <?php echo $settings->content_box_padding['top'].'px'; ?>;
<?php } ?> <?php if( isset($settings->content_box_padding['bottom'] ) ) { ?> padding-bottom: <?php echo $settings->content_box_padding['bottom'].'px'; ?>;
<?php } ?> <?php if( isset($settings->content_box_padding['left'] ) ) { ?> padding-left: <?php echo $settings->content_box_padding['left'].'px'; ?>;
...
.fl-node-<?php echo $id; ?> .gocmbb-testimonial.layout-8 .gocmbb-testimonial-body img {
<?php if( $settings->border_color ) { ?> border-color: <?php echo '#'.$settings->border_color; ?>;
<?php } ?> <?php if( $settings->border_width ) { ?> border-width: <?php echo $settings->border_width.'px'; ?>;
<?php } ?> <?php if( $settings->border_radius ) { ?> border-radius: <?php echo $settings->border_radius.'px'; ?>;
<?php } ?> <?php if( $settings->image_border_style ) { ?> border-style: <?php echo $settings->image_border_style; ?>;
...
<?php  if($settings->show_indicator === 'yes'){ ?>
.gocmbb-testimonial.layout-8 .gocmbb-testimonial-body-left::after {
    border-bottom: 60px solid transparent;
...
.fl-node-<?php echo $id; ?> .gocmbb-testimonial.layout-8 .gocmbb-testimonial-body-left::after {
...
<?php } ?>
<?php  if($settings->show_quote === 'yes'){ ?>
.gocmbb-testimonial.layout-8 .gocmbb-testimonial-body-left p:before {
    color: #fff;
    font-size: 80px;
    left: 80px;
    opacity: 0.2;
...
.fl-node-<?php echo $id; ?> .gocmbb-testimonial.layout-8 .gocmbb-testimonial-body-left p:before {
<?php if( $settings->quote_sign_color ) { ?> color: <?php echo '#'.$settings->quote_sign_color; ?>;
<?php } ?>
}
...
.fl-node-<?php echo $id; ?> .gocmbb-testimonial.layout-9 .gocmbb-testimonial-body-quote-box {
<?php if( $settings->layout_4_content_bg ) { ?> background: <?php echo '#'.$settings->layout_4_content_bg; ?>;
<?php } ?> <?php if( $settings->quote_box_rotate ) { ?> transform: rotate(<?php echo $settings->quote_box_rotate; ?>deg);
<?php } ?>
}

.fl-node-<?php echo $id; ?> .gocmbb-testimonial.layout-9 .gocmbb-testimonial-quote-box-content {
